...
def power_calculator():
    ...
    if st.button('Calculate Power'):
        ...
        if result is not None:
            st.write(f"Calculated Power: {result:.2f} watts")
        else:
...
def three_phase_power_calculator():
    ...
    type = st.selectbox('Select Power Type', ('Real Power', 'Reactive Power', 'Apparent Power','Three Phase Power'))
    if type == 'Real Power':
...
def main():
    ...
    calculator_option = st.sidebar.selectbox('Select Calculator', ('Per-unit Calculator','DC Power Calculator', 'AC Power Calculator'))
    
    if calculator_option == 'Per-unit Calculator':
        per_unit_calculator()
    elif calculator_option == 'DC Power Calculator':
        power_calculator()
    elif calculator_option == 'AC Power Calculator':
